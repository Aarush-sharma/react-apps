    ...
    <>
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="h-3/4 w-2/5 bg-transparent backdrop-blur-lg flex flex-col pl-10 justify-center border-solid border-gray-300 border rounded-[80px] shadow-lg">
          ...
          />
          <label htmlFor="Password" className="ml-7 mt-10">
            Password
          </label>
          <ToggleButton />
          <button
            type="submit"
            className="border border-gray-900 w-24 h-8 self-center top-10 relative -left-5 hover:bg-orange-200 transition rounded-[5px]"
          >
            Log in{" "}
          </button>
        </div>
